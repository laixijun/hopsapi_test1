...
class SpiderDemo:
    ...
    # 企业认证
    def companyAuthencition(self,driver):
        driver = self.companyIdentify(driver)
    ...
    def receiveFund(self,driver):
        ...
        return driver
    # 企业认证企业信息录入
    def companyIdentify(self,driver):
        ...
        el7.clear()
        sleep(3)
        el7.send_keys("911101085636363795")
        ...
        el12.clear()
        sleep(3)
        el12.send_keys(" 911101085636363795")
        # 滑动界面
        ta = ToolsAppium()
        driver=ta.swipeUp(driver)
...
class ToolsAppium:
    ...
    def bankBranchChoose(self,driver):
        el1 = driver.find_element_by_id("com.easylife.house.broker.test:id/tvBankCardOpenBankSubName")
        el1.click()
        el3 = driver.find_element_by_id("com.easylife.house.broker.test:id/edSearch")
        el3.click()
        el4 = driver.find_element_by_id("com.easylife.house.broker.test:id/edSearch")
        ...
        driver.keyevent('66')
        el1 = driver.find_element_by_xpath(
            "/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.widget.LinearLayout/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[7]/android.widget.TextView")
        el1.click()
        return driver
...
if __name__ == "__main__":
    sd=SpiderDemo()
    driver=sd.startApp()
    driver=sd.loginApp(driver,phone='17610775285')
    sleep(5)
    driver = sd.companyAuthencition(driver)
    ta=ToolsAppium()
    # ta.swipeUp(driver)
    # ta.swipeUp(driver)
    # ta.swipeDown(driver)
